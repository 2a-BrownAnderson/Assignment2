angular.module('listings').controller('ListingsController', ['$scope', 'Listings', 
  function($scope, Listings) {
    ...
    $scope.showDetails = function(index) {
      ...
      $scope.detailsAddress = $scope.lt[index].address;
      $scope.detailsLatitude = $scope.lt[index].coordinates.latitude;
      $scope.detailsLongitude = $scope.lt[index].coordinates.longitude;
    };
